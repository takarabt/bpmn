...
public class Bpmn2FactoryImpl extends EFactoryImpl implements Bpmn2Factory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case Bpmn2Package.ARTIFACT: return createArtifact();
			...
			case Bpmn2Package.BASE_ELEMENT: return createBaseElement();
			...
			case Bpmn2Package.CALLABLE_ELEMENT: return createCallableElement();
			...
			case Bpmn2Package.CONVERSATION_NODE: return createConversationNode();
			...
			case Bpmn2Package.INTERACTION_NODE: return createInteractionNode();
