...
public class BpmndiFactoryImpl extends EFactoryImpl implements BpmndiFactory {
	...
	public static BpmndiFactory init() {
		try {
			BpmndiFactory theBpmndiFactory = (BpmndiFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.omg.org/spec/BPMN/20100524/BPMNDI-XMI"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case BpmndiPackage.BOUNDS: return createBounds();
			case BpmndiPackage.POINT: return createPoint();
			case BpmndiPackage.FONT: return createFont();
