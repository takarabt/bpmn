 ...
 * <ul>
 *   <li>{@link bpmndi.LabeledEdge#getOwnedLabel <em>Owned Label</em>}</li>
 * </ul>
 * </p>
 *
 * @see bpmndi.BpmndiPackage#getLabeledEdge()
 * @model abstract="true"
...
public interface LabeledEdge extends Edge {
	 ...
	 * @see bpmndi.BpmndiPackage#getLabeledEdge_OwnedLabel()
