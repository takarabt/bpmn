...
/**
 * This is the item provider adapter for a {@link bpmn2.ComplexBehaviorDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComplexBehaviorDefinitionItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Bpmn2Package.eINSTANCE.getComplexBehaviorDefinition_Condition());
			childrenFeatures.add(Bpmn2Package.eINSTANCE.getComplexBehaviorDefinition_Event());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Bpmn2Package.eINSTANCE.getComplexBehaviorDefinition_Condition(),
				 Bpmn2Factory.eINSTANCE.createFormalExpression()));

		newChildDescriptors.add
			(createChildParameter
				(Bpmn2Package.eINSTANCE.getComplexBehaviorDefinition_Event(),
