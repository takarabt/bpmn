...
/**
 * This is the item provider adapter for a {@link bpmn2.ConversationAssociation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Bpmn2Package.eINSTANCE.getConversationAssociation_InnerConversationNodeRef(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Bpmn2Package.eINSTANCE.getConversationAssociation_OuterConversationNodeRef(),
				 true,
				 false,
				 true,
				 null,
