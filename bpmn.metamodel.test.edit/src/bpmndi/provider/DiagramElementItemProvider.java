...
/**
 * This is the item provider adapter for a {@link bpmndi.DiagramElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BpmndiPackage.Literals.DIAGRAM_ELEMENT__OWNING_DIAGRAM,
				 false,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BpmndiPackage.Literals.DIAGRAM_ELEMENT__OWNING_ELEMENT,
				 false,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BpmndiPackage.Literals.DIAGRAM_ELEMENT__OWNED_ELEMENT,
				 false,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BpmndiPackage.Literals.DIAGRAM_ELEMENT__MODEL_ELEMENT,
				 false,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BpmndiPackage.Literals.DIAGRAM_ELEMENT__STYLE,
				 false,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_DiagramElement_id_feature", "_UI_DiagramElement_type"),
				 BpmndiPackage.Literals.DIAGRAM_ELEMENT__ID,
				 true,
				 false,
				 false,
